...
const StageExam: React.FC<Props> = ({ task, t, examActive, timerSec, formatTime, onRetry, personalBestSec }) => {
  ...
  return (
    <div className="flex-1 flex flex-col p-5 gap-4">
      ...
      <div
        className="flex-1 flex flex-col items-center justify-center border rounded-xl p-6 text-center"
      ...
      >
        {!examActive && timerSec === 0 ? (
          ...
          <>
            ...
            <div
              className="text-sm font-mono font-bold px-4 py-2 rounded-lg border"
              style={{
                color: 'var(--neon-red)',
            ...
            {personalBestSec !== undefined && personalBestSec !== null && (
              <div
                className="w-full mt-5 p-4 border rounded-lg flex flex-col gap-2.5 font-mono text-[10px] text-left"
              ...
              >
                <div className="flex justify-between items-center text-[9px] uppercase tracking-wider text-[var(--text-muted)]">
                  ...
                  <span
                    className={elapsedSec <= personalBestSec ? 'text-[var(--neon-green)]' : 'text-[var(--neon-red)]'}
                  >
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <div>
                    ...
                    <div
                      className="h-1.5 w-full bg-[var(--bg-elevated)] rounded-sm overflow-hidden border"
                      style={{ borderColor: 'var(--border)' }}
                    >
                      <div
                        className="h-full bg-[var(--neon-cyan)] transition-all duration-1000 shadow-[0_0_8px_var(--neon-cyan)]"
                  ...
                  <div>
                    ...
                    <div
                      className="h-1.5 w-full bg-[var(--bg-elevated)] rounded-sm overflow-hidden opacity-60 border"
                      style={{ borderColor: 'var(--border)' }}
                    >
                      <div
                        className="h-full bg-[var(--neon-magenta)] shadow-[0_0_8px_var(--neon-magenta)]"
                        style={{ width: '100%' }}
                      />
                    </div>
                  </div>
