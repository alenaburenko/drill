...
export const Header: React.FC<HeaderProps> = ({
  lang, theme, crtActive, activeTab, taskCount,
  onToggleLang, onCycleTheme, onToggleCrt, onTabClick, t,
}) => {
  ...
  return (
    <header className="sticky top-0 z-30 px-6 py-3 flex items-center justify-between border-b glitch-spasm-rare"
