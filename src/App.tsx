...
import {
  ...
  Terminal, Globe, ChevronDown, ChevronUp
} from 'lucide-react';
...
const stageBadge = (mastered: boolean, stage: number) =>
  mastered
                  ...
                  <div className="lg:col-span-8 flex flex-col gap-5">
                    ...
                    <div className="rounded-2xl border p-5" style={{ background: 'var(--bg-surface)', borderColor: 'var(--border)' }}>
                      <div className="flex items-center justify-between mb-4 pb-3 border-b" style={{ borderColor: 'var(--border-muted)' }}>
                        ...
                        <button onClick={() => setActiveTab('catalog')} className="text-xs font-bold transition-colors hover:underline" style={{ color: 'var(--accent)' }}>
                          {t.viewAll}
                        </button>
                      </div>
